...
class SettingsPanel:
    ...
    def _place_handle(self) -> None:
        self._handle.place(self._screen_geometry())
    ...
    def show_panel(self) -> None:
        if not self.available or self._open:
            return
        self._open = True
        self._panel.slide_in(self._screen_geometry())

    def hide_panel(self) -> None:
        if not self.available or not self._open:
            return
        self._open = False
        self._panel.slide_out(self._screen_geometry())
